...
@section('title') ETM - Admin Panel - Manage Students @endsection
    ...
    <div class="table">
        <div class="table-wrapper">
            <div class="table-title mb-3">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    ...
                    <div class="my-3 my-md-0 search">
                        <form class="d-flex" action="{{ route('search-student') }}" method="get" role="search">
            ...
            <table class="table table-responsive table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Mid&nbsp;Name</th>
                        <th>Group</th>
                        <th>Library&nbsp;Card&nbsp;Code</th>
                        <th>User</th>
                        <th>Registered&nbsp;On</th>
                        <th>
                            <div>
                                <a href="/admin/manage/students/create" class="btn btn-success">
                                    <span>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('search-user', 'search=' . $student->user_id) }}">
                                {{ $student->user_id }}
                            </a>
                        </td>
                        ...
                        <td>
                            <form action="{{ route('delete-student', $student->id) }}" method="post">
                                ...
                                <div class="d-flex flex-row">
                                    <a href="/admin/manage/students/update-{{ $student->id }}" class="mx-1 btn btn-primary"
                                        role="button">
            ...
            <div class="d-flex justify-content-center my-5">
                {{ $students->withQueryString()->links('pagination.default') }}
            </div>
