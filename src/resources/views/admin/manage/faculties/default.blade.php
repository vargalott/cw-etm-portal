...
@section('title') TMD - Admin Panel - Manage Faculties @endsection
            ...
            <table class="table table-responsive-lg table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $faculty->name }}</td>
                        <td>
                            <a target="_blank" href="{{ Storage::url($faculty->thumbnail) }}">{{ $faculty->thumbnail }}</a>
                        </td>
                        <td>
                            <form action="{{ route('delete-faculty', $faculty->id) }}" method="post">
                                ...
                                <div class="d-flex flex-row">
                                    <a href="/admin/manage/faculties/update-{{ $faculty->id }}" class="mx-1 btn btn-primary"
                                        role="button">
